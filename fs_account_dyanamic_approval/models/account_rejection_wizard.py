...
class AccountRejectionReasonWizard(models.TransientModel):
    _name = "account.sh.reject.reason.wizard"
    _description = "Account Reject reason wizard"
    ...
    def action_reject_order(self):
        ...
        template_id = active_obj.env.ref(
            "fs_account_dyanamic_approval.email_template_for_reject_account_move"
        )
        ...
        if active_obj.user_id:
            notifications.append(
                [
                    active_obj.invoice_user_id.partner_id,
                    (
                    ...
                    ),
                    {
                        ...
                        "message": "Dear User!! your %s %s is rejected"
                        % (active_obj.journal_id.name, active_obj.name),
                        "sticky": True,
                        "warning": True,
                    },
                ]
